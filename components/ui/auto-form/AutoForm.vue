    ...
    <slot name="customAutoForm" :fields="fields">
      <div class="grid grid-cols-2 gap-4">
        <template v-for="(field, key) in fields" :key="key">
          <div
            :class="
              field.config?.rowSpan !== 'single' ? 'col-span-2' : 'col-span-1'
            "
          >
            <AutoFormField
              :config="field.config"
